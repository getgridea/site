  ...
  <div class="home-page">
    <div class="hero-container">
      ...
      <div class="hero-content">
        ...
        <div class="right">
          <img
            src="https://raw.githubusercontent.com/getgridea/gridea/master/gridea-app-en.png"
            alt="Gridea"
            class="app-img"
          />
        </div>
    ...
    <div class="container-wrapper">
      <div class="container">
        ...
        >In addition to these, there are some things you might expect (topics include): KaTeX formula, Google Analytics, social links, TOC ..., are you excited? Download quickly!</div>
    ...
    <div class="home-content">
      <p>
        <span class="large-icon">🌱</span> Of course Gridea is still very basic, but please believe that it will keep moving forward.
      ...
      <a
        href="https://t.me/joinchat/IDY0ahRqb8NPodv95BNpBg"
        target="_blank"
      >Telegram Group(Chinese)</a>
